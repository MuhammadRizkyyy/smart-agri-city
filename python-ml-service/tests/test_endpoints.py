...
def test_predict_yield_invalid_moisture(client):
    payload = {
...
def test_predict_pest_valid(client):
    payload = {
...
def test_predict_irrigation_valid(client):
    payload = {
...
def test_predict_irrigation_invalid_phase(client):
    payload = {
        "soil_moisture": 20.0, "air_temp": 30.0, "rain_forecast": 10.0,
